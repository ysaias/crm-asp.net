<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaCiudad.aspx.cs" Inherits="ListaCiudad" %>
...
<body>
    ...
    <div class="row">
        <div class="col-12">
            <h1>Lista Ciudad</h1>
            <asp:HyperLink runat="server" NavigateUrl="~/RegistroCiudad.aspx" CssClass="btn btn-primary">
                Nueva Ciudad
            </asp:HyperLink>
            <br /><br />
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <asp:GridView ID="ciudadGridView" runat="server" CssClass="table" 
                    ...
                    <asp:TemplateField HeaderText="Eliminar">
                        <ItemTemplate>
                            <asp:LinkButton ID="DeleteBtn" runat="server" CommandName="Eliminar"
                                OnClientClick="return confirm('¿Esta seguro que desea eliminar este Dato?')"
                                CommandArgument='<%# Eval("idCiudad") %>'>
