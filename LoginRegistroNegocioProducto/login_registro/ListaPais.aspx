<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaPais.aspx.cs" Inherits="ListaPais" %>
...
<body>
    ...
    <div class="row">
        <div class="col-12">
            <h1>Lista Pais</h1>
            <asp:HyperLink runat="server" NavigateUrl="~/RegistroPais.aspx" CssClass="btn btn-primary">
                Nuevo Pais
            </asp:HyperLink>
            <br /><br />
        </div>
