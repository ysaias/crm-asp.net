<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistroPais.aspx.cs" Inherits="RegistroPais" %>
            ...
            <form id="registroLineaNegocio" runat="server" method="post">
                ...
                <div class="row">
                  <div class="col-12">
                        ...
                        <asp:HyperLink runat="server" NavigateUrl="ListaPais.aspx">
                            Volver a la Lista de Pais
                        </asp:HyperLink>
                ...
                <asp:HiddenField ID="paisIdHiddenField" runat="server" Value="0" />
            </form>
