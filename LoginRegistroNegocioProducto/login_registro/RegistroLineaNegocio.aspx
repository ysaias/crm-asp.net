...
<!--ESTO ES REGISTRO-->
    <div class="registroLineaNegocio">
            <form id="registroLineaNegocio" runat="server" method="post">
                    ...
                    <div class="col-6">
                        ...
                        DataTextField="nombre" DataValueField="empresaId" Height="46px" >
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                OldValuesParameterFormatString="original_{0}" SelectMethod="prSelectUsuario" 
                                TypeName="EmpresaDSTableAdapters.EmpresaDaoTableAdapter">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="useridHiddenField1" PropertyName="Value" DefaultValue="0" Name="usuarioId" Type="Int32"></asp:ControlParameter>
                                </SelectParameters>
                ...
                <asp:HiddenField ID="useridHiddenField1" runat="server" Value="0" />
            </form>
