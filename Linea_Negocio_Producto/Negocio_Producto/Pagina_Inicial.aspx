...
<body>
    <div class="registroLogin">
            ...
            <form id="formLogin" runat="server" method="post">
                <label>Codigo:</label>
                <asp:TextBox ID="codigoTxt" cssClass="texto" name="user" runat="server"></asp:TextBox>
                <label>Nombre:</label>
                <asp:TextBox ID="nombreTxt" cssClass="texto" name="user" runat="server"  placeholder="Ingrese Nombre de Linea de Negocio"></asp:TextBox>
