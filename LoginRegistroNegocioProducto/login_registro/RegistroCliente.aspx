            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <div class="navbar-nav mr-auto ml-auto text-center">
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkActividad" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">OPORTUNIDAD 
                        </a>
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkOportunidad" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Registar Cliente 
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <div class="registroOportunidad">
                        <div id="formOportunidad">
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="pr_SelectCiudad" TypeName="CiudadDSTableAdapters.tblCiudadTableAdapter"
                            ...
                            <div class="form-group">
                                <asp:LinkButton ID="guardarBtn" runat="server" OnClick="SaveButton_Click"
                                    ...
                                    ValidationGroup="Producto" Width="300px">
                                Guardar
                                </asp:LinkButton>
                                <asp:HyperLink runat="server" NavigateUrl="ListCliente.aspx" CssClass="btn" Width="300px">
                                Cancelar
                                </asp:HyperLink>
                            </div>
